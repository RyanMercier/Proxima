...
\title{Distance-Preserving Digests:\\ A Primitive for BFT Consensus
\thanks{Code and reproduction artifacts: \url{https://github.com/RyanMercier/Proxima}}
}

\author{\IEEEauthorblockN{Ryan Mercier}
...
\begin{IEEEkeywords}
Byzantine fault tolerance, blockchain, consensus protocols, locality-sensitive hashing, sharding
\end{IEEEkeywords}
...
\bibitem{yin2019hotstuff} M. Yin, D. Malkhi, M. K. Reiter, G. Golan-Gueta, and I. Abraham, ``HotStuff: BFT Consensus with Linearity and Responsiveness,'' in \textit{Proc. PODC}, 2019.
\bibitem{castro1999pbft} M. Castro and B. Liskov, ``Practical Byzantine Fault Tolerance,'' in \textit{Proc. OSDI}, 1999.
\bibitem{boneh2004bls} D. Boneh, B. Lynn, and H. Shacham, ``Short Signatures from the Weil Pairing,'' \textit{J. Cryptol.}, vol. 17, no. 4, pp. 297--319, 2004.
\bibitem{blst} Supranational, ``blst: BLS12-381 signature library,'' \url{https://github.com/supranational/blst}.
\bibitem{eth2spec} Ethereum Foundation, ``Ethereum 2.0 Beacon Chain Specification,'' \url{https://github.com/ethereum/consensus-specs}.
\bibitem{lighthouse-bls} Sigma Prime, ``Lighthouse Update \#27: BLS library performance,'' \url{https://lighthouse-blog.sigmaprime.io/update-27.html}, 2020.
\bibitem{eth2update8} Ethereum Foundation, ``Eth2 Quick Update No.\ 8,'' \url{https://blog.ethereum.org/2020/05/12/eth2-quick-update-no-8}, 2020.
\bibitem{drake-bls} J. Drake, ``Pragmatic Signature Aggregation with BLS,'' \url{https://ethresear.ch/t/pragmatic-signature-aggregation-with-bls/2105}, ethresear.ch, 2018.
\bibitem{buchman2016tendermint} E. Buchman, ``Tendermint: Byzantine Fault Tolerance in the Age of Blockchains,'' Ph.D. dissertation, University of Guelph, 2016.
\bibitem{bloom1970} B. Bloom, ``Space/Time Trade-offs in Hash Coding with Allowable Errors,'' \textit{Commun. ACM}, vol. 13, no. 7, pp. 422--426, 1970.
\bibitem{indyk1998lsh} P. Indyk and R. Motwani, ``Approximate Nearest Neighbors: Towards Removing the Curse of Dimensionality,'' in \textit{Proc. STOC}, 1998.
\bibitem{dwork1988partialsync} C. Dwork, N. Lynch, and L. Stockmeyer, ``Consensus in the Presence of Partial Synchrony,'' \textit{J. ACM}, vol. 35, no. 2, pp. 288--323, 1988.
\bibitem{nightshade} A. Skidanov, ``Nightshade: Near Protocol Sharding Design,'' \url{https://pages.near.org/papers/nightshade/}.
\bibitem{kauri} R. Neiheiser, M. Matos, and L. Rodrigues, ``Kauri: Scalable BFT Consensus with Pipelined Tree-Based Dissemination and Aggregation,'' in \textit{Proc. SOSP}, 2021.
\bibitem{narwhal} G. Danezis, L. Kokoris-Kogias, A. Sonnino, and A. Spiegelman, ``Narwhal and Tusk: A DAG-based Mempool and Efficient BFT Consensus,'' in \textit{Proc. EuroSys}, 2022.
\bibitem{bullshark} A. Spiegelman, N. Giridharan, A. Sonnino, and L. Kokoris-Kogias, ``Bullshark: DAG BFT Protocols Made Practical,'' in \textit{Proc. CCS}, 2022.
\bibitem{simhash} M. Charikar, ``Similarity Estimation Techniques from Rounding Algorithms,'' in \textit{Proc. STOC}, 2002.
\bibitem{minhash} A. Broder, ``On the Resemblance and Containment of Documents,'' in \textit{Proc. SEQUENCES}, 1997.
\bibitem{pstable} M. Datar, N. Immorlica, P. Indyk, and V. Mirrokni, ``Locality-Sensitive Hashing Scheme Based on $p$-Stable Distributions,'' in \textit{Proc. SCG}, 2004.
\bibitem{danksharding} Ethereum Foundation, ``Danksharding,'' \url{https://ethereum.org/roadmap/danksharding}.
\bibitem{pyecc} Ethereum Foundation, ``py-ecc: Python BLS library,'' \url{https://github.com/ethereum/py_ecc}.
\bibitem{wagner2002gbp} D. Wagner, ``A Generalized Birthday Problem,'' in \textit{Proc. CRYPTO}, 2002, pp.\ 288--304.
